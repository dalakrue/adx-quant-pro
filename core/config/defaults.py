...
# V24: sidebar-level navigation is intentionally simple.
# Heavy workspaces moved under the lazy "Other" inner tab, and EURUSD H1
# decision matrix moved under Lunch.
DEFAULT_TABS = [
    "Lunch",
    "Other",
]
